...
am__append_1 = shell
am__append_2 = test
am__append_3 = thumbnailer
am__append_4 = previewer
subdir = .
...
am__installdirs = "$(DESTDIR)$(headerdir)" "$(DESTDIR)$(pkgconfigdir)"
DATA = $(header_DATA) $(pkgconfig_DATA)
...
ZLIB_LIBS = -lz
abs_builddir = /home/turpif/Projects/evince-3.10.3
abs_srcdir = /home/turpif/Projects/evince-3.10.3
...
installdirs-am:
	for dir in "$(DESTDIR)$(headerdir)" "$(DESTDIR)$(pkgconfigdir)"; do \
...
install-data-am: install-headerDATA install-pkgconfigDATA
...
uninstall-am: uninstall-headerDATA uninstall-pkgconfigDATA
